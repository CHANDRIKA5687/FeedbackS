            ...
            <div class="row w-100 mx-0">
                <div class="col-lg-6 mx-auto">
                    <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                        <h4 class="font-weight-dark" style="text-align:center">Add Course Here</h4>
                    ...
                    <?php endif; ?>
                        <form class="pt-3" action="<?php echo base_url('addCourse');?>" method="post">
                            <div class="form-group">
                                <label for="shortform"><b>Branch</b></label>
                                <select class="form-control form-control-lg" id="exampleFormSelectBranch" name="branch"
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-lg" id="exampleFormSelectBranch" name="semester"
                                    style="color:black" required>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control form-control-lg" id="exampleFormSelectBranch" name="class"
                                    style="color:black" required>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control form-control-lg" id="exampleInputCourseid"
                                    placeholder="Course ID" name="courseid" required>
                            </div>

                            <div class="form-group">
                                <label for="fullform"><b>Full Form</b></label>
                                <input type="text" class="form-control form-control-lg" id="exampleInputFullForm"
                                    placeholder="Full Form" name="fForm" required>
                            </div>

                            <div class="form-group">
                                <label for="shortform"><b>Short Form</b></label>
                                <input type="text" class="form-control form-control-lg" id="exampleInputShortForm"
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control form-control-lg" id="exampleInputWeightage"
                                    placeholder="Total Weightage" name="weightage" required>
                            </div>

                            <div class="form-group">
                            0    <label for="totalweightage"><b>Choose</b></label>
                                <div class="container">
                                    <div class="row">
                                        <div class="col-sm-4">
