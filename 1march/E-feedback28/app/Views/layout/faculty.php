    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="<?php echo base_url('faculty');?>">
                    <img src="<?php echo base_url('assets/images/spspm1.png');?>" class="mr-2"
                        alt="logo" style="height:50px;width:150px" /></a>
                <a class="navbar-brand brand-logo-mini" href="<?php echo base_url('faculty');?>">
        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    <li class="nav-item">
                        <a class="nav-link" href="<?php echo base_url('faculty');?>">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="collapse" href="#ui-basic" aria-expanded="false"
                            ...
                            <span class="menu-title">View Feedback Report</span>
                            <i class="menu-arrow"></i>
                        </a>
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('facultyThReport');?>">Theory 
                                        Feedback</a></li>
                                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('facultyPrReport');?>">Practical
                                        Feedback</a></li>
                            </ul>
                        </div>
                    </li>
