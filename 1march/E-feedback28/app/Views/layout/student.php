    ...
    <div class="container-scroller">
        ...
        <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo mr-5" href="<?php echo base_url('student');?>">
                    <img src="<?php echo base_url('assets/images/spspm1.png');?>" class="mr-2"
                        alt="logo" style="height:50px;width:150px" /></a>
                <a class="navbar-brand brand-logo-mini" href="<?php echo base_url('student');?>">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('theoryFeedback');?>">Theory 
                                        Feedback</a></li>
                                <li class="nav-item"> <a class="nav-link" href="<?php echo base_url('practicalFeedback');?>">Practical
                                        Feedback</a></li>
                            </ul>
                        </div>
                    </li>
